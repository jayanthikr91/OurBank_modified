...
public class Admin_AddEmp implements Serializable {
	...
	//Commented since the table has auto incremented value and the schema cannot be changed
	//This leads to incorrect data in the table where same employee id can be used for multiple users
	//private Long id;
