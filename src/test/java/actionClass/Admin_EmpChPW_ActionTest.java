...
public class Admin_EmpChPW_ActionTest extends StrutsTestCase {



	Admin_EmpChPW_DaoImpl mockDAO;
	
	@Override
	protected void setUp() throws Exception {
		super.setUp();
		// DAO layer mock
		mockDAO = Mockito.mock(Admin_EmpChPW_DaoImpl.class);
	}
	...
	public void testChangepw() throws Exception {
        ...
        ActionProxy proxy = getActionProxy("/adm_emp_changepw");
        Admin_EmpChPW_Action action = (Admin_EmpChPW_Action) proxy.getAction();
